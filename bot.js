...
P.S. Данная процедура является обязательной для вступления в чат, не передает ее на сторонние ресурсы и не запоминает ее! 🛡️ Анкета составляется согласно шаблону и публикуется в чате, в разделе анкеты. 📍`,
